...
DEBUG = True  # Enable for development - change to False in production
...
# Email (console en développement, SMTP en production)
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = "no-reply@shopinline.com"
